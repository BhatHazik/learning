  ...
  return (
    <div className="w-100 mb-4">
      ...
      <header className="d-flex align-items-center justify-content-between px-2 ps-3 py-2 mt-2 mb-2 app-white">
        ...
        <button className="mobile-view rounded-2 border-0 py-1 px-3 fw-lightBold mb-0 h-auto app-black">
          <Link onClick={handleCancel} to="/courses" className="text-decoration-none text-white">
            Cancel
          </Link>
        </button>
        <button className="desktop-view bg-gradient-custom-div rounded-2 border-0 py-1 px-3 fw-lightBold mb-0 h-auto app-black">
          <Link onClick={handleCancel} to="/courses" className="text-decoration-none text-white">
            Cancel
          </Link>
        </button>
          ...
          <div className="d-flex justify-content-between align-items-center">
            {isEditMode ? (
              ...
              <>
                <button
                  type="button"
                  className="mobile-view app-black app-text-white rounded-2 border-0 py-2 px-3 fw-lightBold mb-0 h-auto"
                ...
                <button
                  type="submit"
                  className="mobile-view  app-red rounded-2 border-0 py-2 px-3 fw-lightBold mb-0 h-auto app-text-white"
                >
                  {loading ? (
                    <PulseLoader size={8} color="white" />
                  ) : (
                ...
                <button
                  type="button"
                  className="desktop-view border rounded-2  py-2 px-3 fw-lightBold mb-0 h-auto "
                  onClick={handleCancel}
                >
                  Cancel
                </button>
                <button
                  type="submit"
                  className="desktop-view bg-gradient-custom-div rounded-2 border-0 py-2 px-3 fw-lightBold mb-0 h-auto app-black"
                >
                  {loading ? (
                    <PulseLoader size={8} color="white" />
                  ) : (
